...
const NavigationDashboard: FC<NavigationDashboardProps> = (props) => {
  ...
  return (
    <nav className={classList('d-flex align-center', styles.navigation, isActive && styles.active, className)}>
      <div className={`d-flex align-center gap-16`}>
        {isMobileScreen && 
          <Button onClick={onClick} className={styles.search} prefix="normal" color='inherit' variant='text'>
            <IconNav/>
          </Button>
        }
